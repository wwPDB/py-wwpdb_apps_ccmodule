...
class ChemCompWebAppLiteWorker(object):
    ...
    def _generateSummaryData(self):
        """ Check for ligang analysis results made in deposition step.
        For now it fails if it didn't find anything.
        ...
        if (self.__verbose):
            ...
            self.__lfh.write("+%s.%s() identifier   %s\n"%(self.__class__.__name__, sys._getframe().f_code.co_name, str(self.__reqObj.getValue("identifier"))) )
