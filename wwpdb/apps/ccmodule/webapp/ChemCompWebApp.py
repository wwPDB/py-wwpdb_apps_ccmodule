...
class ChemCompWebAppWorker(object):
    def __init__(self, reqObj=None, verbose=False,log=sys.stderr):
        ...
        self.__appPathD={'/service/environment/dump':                       '_dumpOp',
                         ...
                         # report endpoints
                         '/service/cc/report/file':                             '_getReportFile',
                         '/service/cc/report/status':                           '_getLigandAnalysisStatus',                   
                         }
    ...
    def _getReportFile(self):
        ...
        if (self.__verbose):
            self.__logger.info("Requesting file '%s' from '%s' for deposition '%s'", filename, source, depId)
                ...
                if( len(instIdLst) > 0):
                    ...
                    for instId in instIdLst:
                        ...
                        for tupL in mtchL:
                            ccId = tupL[0]
                            HitList.append(ccId)
                            if( not ccId in ccIdAlrdySeenLst ):
