...
class ChemCompAssignDataStore(object):
    ...
    def __init__(self,reqOb,verbose=False,log=sys.stderr):
        ...
        self.__dpstrUpldFlsOrder={}     #admin/convenience dict for keeping track of order in which files were uploaded for a given ligid, so that authoritative precedence given to most recent uploads
    ...
    def serialize(self):
        ...
        try:
            ...
            cPickle.dump(self.__authAssignment,fb,self.__pickleProtocol)
            cPickle.dump(self.__batchBestHitAssignment,fb,self.__pickleProtocol)
            cPickle.dump(self.__annotAssignment,fb,self.__pickleProtocol)
            cPickle.dump(self.__topHitsList,fb,self.__pickleProtocol)
            cPickle.dump(self.__newCandidatesList,fb,self.__pickleProtocol)
            cPickle.dump(self.__ccNameList,fb,self.__pickleProtocol)
            cPickle.dump(self.__ccFormulaList,fb,self.__pickleProtocol)
            cPickle.dump(self.__ccFormalChrgList,fb,self.__pickleProtocol)
            cPickle.dump(self.__ccAssignmentWarning,fb,self.__pickleProtocol)
            cPickle.dump(self.__ccSingleAtomFlag,fb,self.__pickleProtocol)
            cPickle.dump(self.__annotNotes,fb,self.__pickleProtocol)
            cPickle.dump(self.__rerunParam_linkRadii,fb,self.__pickleProtocol)
            cPickle.dump(self.__rerunParam_bondRadii,fb,self.__pickleProtocol)
            cPickle.dump(self.__atomMapDct,fb,self.__pickleProtocol)
            cPickle.dump(self.__drtyGrpCnts,fb,self.__pickleProtocol)
            cPickle.dump(self.__drtyGrpList,fb,self.__pickleProtocol)
            cPickle.dump(self.__GlbllyAssgndGrpLst,fb,self.__pickleProtocol)
            cPickle.dump(self.__GlbllyAssgndDict,fb,self.__pickleProtocol)
            cPickle.dump(self.__GlblRerunSrchDict_lnkRadii,fb,self.__pickleProtocol)
            cPickle.dump(self.__GlblRerunSrchDict_bndRadii,fb,self.__pickleProtocol)
            cPickle.dump(self.__GlblRerunSrchLst,fb,self.__pickleProtocol)
            cPickle.dump(self.__instncRerunSrchLst,fb,self.__pickleProtocol)
            cPickle.dump(self.__newCcDefined,fb,self.__pickleProtocol)
            # chem comp lite attribs below
            cPickle.dump(self.__GlbllyRslvdGrpLst,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrInvalidGrpIdLst,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrCcExactMatchId,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrCcAltId,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrCcType,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrCcName,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrCcFrmla,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrSubmitChoice,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrCcDscrptrType,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrCcDscrptrStr,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrComments,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrUploadFiles,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrSketchFiles,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrSketchMolStr,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrAttnRqdGrpLst,fb,self.__pickleProtocol)
            cPickle.dump(self.__rslvdPrtnCntr,fb,self.__pickleProtocol)
            cPickle.dump(self.__rslvdPrtnDict,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrUpldFlsOrder,fb,self.__pickleProtocol)
            cPickle.dump(self.__rsrchAcqurdGrpLst,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrCcRsrchInfo,fb,self.__pickleProtocol)
            cPickle.dump(self.__rsrchSlctdGrpLst,fb,self.__pickleProtocol)
            cPickle.dump(self.__dpstrOrigCcIdMaster,fb,self.__pickleProtocol)
            fb.close()
        except:
    ...
    def deserialize(self):
        ...
        try:
            ...
            self.__authAssignment=cPickle.load(fb)
            self.__batchBestHitAssignment=cPickle.load(fb)
            self.__annotAssignment=cPickle.load(fb)
            self.__topHitsList=cPickle.load(fb)
            self.__newCandidatesList=cPickle.load(fb)
            self.__ccNameList=cPickle.load(fb)
            self.__ccFormulaList=cPickle.load(fb)
            self.__ccFormalChrgList=cPickle.load(fb)
            self.__ccAssignmentWarning=cPickle.load(fb)
            self.__ccSingleAtomFlag=cPickle.load(fb)
            self.__annotNotes=cPickle.load(fb)
            self.__rerunParam_linkRadii=cPickle.load(fb)
            self.__rerunParam_bondRadii=cPickle.load(fb)
            self.__atomMapDct=cPickle.load(fb)
            self.__drtyGrpCnts=cPickle.load(fb)
            self.__drtyGrpList=cPickle.load(fb)
            self.__GlbllyAssgndGrpLst=cPickle.load(fb)
            self.__GlbllyAssgndDict=cPickle.load(fb)
            self.__GlblRerunSrchDict_lnkRadii=cPickle.load(fb)
            self.__GlblRerunSrchDict_bndRadii=cPickle.load(fb)
            self.__GlblRerunSrchLst=cPickle.load(fb)
            self.__instncRerunSrchLst=cPickle.load(fb)
            self.__newCcDefined=cPickle.load(fb)
            # chem comp lite attribs below
            self.__GlbllyRslvdGrpLst=cPickle.load(fb)
            self.__dpstrInvalidGrpIdLst=cPickle.load(fb)
            self.__dpstrCcExactMatchId=cPickle.load(fb)
            self.__dpstrCcAltId=cPickle.load(fb)
            self.__dpstrCcType=cPickle.load(fb)
            self.__dpstrCcName=cPickle.load(fb)
            self.__dpstrCcFrmla=cPickle.load(fb)
            self.__dpstrSubmitChoice=cPickle.load(fb)
            self.__dpstrCcDscrptrType=cPickle.load(fb)
            self.__dpstrCcDscrptrStr=cPickle.load(fb)
            self.__dpstrComments=cPickle.load(fb)
            self.__dpstrUploadFiles=cPickle.load(fb)
            self.__dpstrSketchFiles=cPickle.load(fb)
            self.__dpstrSketchMolStr=cPickle.load(fb)
            self.__dpstrAttnRqdGrpLst=cPickle.load(fb)
            self.__rslvdPrtnCntr=cPickle.load(fb)
            self.__rslvdPrtnDict=cPickle.load(fb)
            self.__dpstrUpldFlsOrder=cPickle.load(fb)
            self.__rsrchAcqurdGrpLst=cPickle.load(fb)
            self.__dpstrCcRsrchInfo=cPickle.load(fb)
            self.__rsrchSlctdGrpLst=cPickle.load(fb)
            self.__dpstrOrigCcIdMaster=cPickle.load(fb)
        ...
        try:
            ...
            for instId in self.getAuthAssignmentKeys():
                ...
                if( self.__atomMapDct[instId][assignedId] ):
                    atomMappingInstanceData = self.__atomMapDct[instId][assignedId] # this gives us a list of tuples of form ( '_pdbx_atom_mapping.inst_atom_name','_pdbx_atom_mapping.reference_atom_name')
...
#####################################################################################
    ...
    def dump(self,ofh):
        ...
        for instId in keys:  
            ofh.write("Instance id: %s\n" % instId )
        '''
        ofh.write("\nKeys in newCcDefined dict ----------------------------- \n")   
        keys = self.__newCcDefined.keys()
        keys.sort()
        for instId in keys:  
            ofh.write("Instance id: %s\n" % instId )
            
        ofh.write("\nKeys in annotNotes dict ----------------------------- \n")
        keys = self.__annotNotes.keys()
        keys.sort()
        for instId in keys:  
            ofh.write("Instance id: %s\n" % instId )

        ofh.write("\nKeys in rerunParam_linkRadii dict ----------------------------- \n")
        keys = self.__rerunParam_linkRadii.keys()
        keys.sort()  
        for instId in keys:  
            ofh.write("Instance id: %s\n" % instId )

        ofh.write("\nKeys in rerunParam_bondRadii dict ----------------------------- \n")
        keys = self.__rerunParam_bondRadii.keys()
        keys.sort()  
        for instId in keys:  
            ofh.write("Instance id: %s\n" % instId )
            
        ofh.write("\nKeys in atomMappingList dict ----------------------------- \n")
        keys = self.__atomMapDct.keys()
        keys.sort()   
        for instId in keys:  
            ofh.write("Instance id: %s\n" % instId )
        '''
    ...
    def dumpData(self,ofh):
        ...
        keys.sort()   
        for instId in keys:
            kys = (self.__atomMapDct[instId]).keys()
            for refid in kys:
                ofh.write("atomMapDct dump for instid %s against refid %s: %s\n" % (instId, refid, (self.__atomMapDct[instId])[refid]) )
        '''        
